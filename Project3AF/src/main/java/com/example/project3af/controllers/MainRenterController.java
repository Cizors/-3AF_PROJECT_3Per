...
public class MainRenterController {
    ...
    @FXML
    public ImageView RenterMainRoomImage1;
    @FXML
    public ImageView RenterMainRoomImage2;
    @FXML
    public ImageView RenterMainRoomImage3;
    @FXML
    public ImageView RenterMainRoomImage4;
    @FXML
    public ImageView RenterMainRoomImage5;
    @FXML
    public ImageView RenterMainRoomImage6;
